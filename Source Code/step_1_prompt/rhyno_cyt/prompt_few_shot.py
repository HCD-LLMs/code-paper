...
REQUEST = (
    ...
    You must explore the html code of the application before generating the tasks. 
...
#sono stati selezionati come esempi i task 1 e 2 (1 e 4 nell'articolo) perchè sono i più rappresentativi e onnicomprensivi
