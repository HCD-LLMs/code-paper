...
cat_users = "Doctor specialized in neurology (i.e neurologists) for the diagnosis and detection of Alzheimer's."
...
REQUEST = (
    ...
    1. Verify the correctness of the diagnosis along with its corresponding explanation. 
    2. Ask details about the provided diagnosis to the AI Agent.
    3. Verify that the natural language explanation corresponds to the brain areas highlighted in the image. """)
